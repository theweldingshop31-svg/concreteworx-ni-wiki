...
- [ ] **Reconcile draft-product prices against the pricing sheet (found Session 7, 2026-08-11)** — with the pricing sheet (`1VeMS3LVNqNtZqYKrrd9YH6g_8XGHppU3PUUIPdUYQ9c`) now source of authority and live products reconciled (see [[log]] Session 7), ~31 **draft** (not-yet-published) products still carry a price on the site that's missing or stale vs. the sheet, e.g.: BEN-003–008 (Horsehead/Gargoyle/Roses/Scania/Chelsea/Manchester United Benches, sheet all £100), LGE-001/002/003/005/007/008/009/010/012 (Windmill, Wishing Well, Pergola, Donkey and Cart small, Easter Island Head, Compass, Wagon Wheel, Mushroom House, Compass Paver), PLT-003/004/005/006 (Boy with Wheelbarrow, Acorn Planter/Pot, Angel Pot — note name mismatches too on 004/005), BB-003/009/010 (3 Robins, Geese, Otter Birdbaths), ANI-010/011/012/013/023/024/026/027, STA-015 (Cottage Medium). These were deliberately left untouched in Session 7 since the task scope was live products only — they'll need pricing set correctly **before** each is published, not necessarily right now. Full sheet-vs-site diff not written out row-by-row anywhere yet — would need re-deriving from the sheet and a fresh `wc/v3/products` pull if tackled.
...
- [ ] **Investigate published-product-count drop (found Session 7, 2026-08-11)** — original audit (2026-08-10) counted 50 published products via `X-WP-Total`; a full catalogue pull in Session 7 found only 46 published / 66 draft (112 total). Not investigated — could be products unpublished since, a counting-method difference, or something else. See [[SEO Audit Findings]].
